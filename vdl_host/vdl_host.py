    ...
    while True:
        try:
            ...
            if message:
                url = message.get('url')
                if url:
                    # Validate URL string & scheme to prevent injection / bad input
                    ...
                    if is_windows:
                        ...
                        # Linux: Dynamic terminal emulator detection (konsole, xfce4-terminal, kitty, etc.)
                        import shutil
                        terminals = [
